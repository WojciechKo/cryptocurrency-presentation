...
Niniejszy artykuł przedstawi jakie problemy z pieniędzmi istnieją w dzisiejszym świecie i w jaki sposób pojawienie się
kryptowalut może pomóc je rozwiązać.  W kolejnym rozdziale przedstawię matematyczne koncepcje które zostały wykorzystane
przy projektowaniu kryptowalut.  Następnie opiszę architekturę kryptowalut, czyli czym jest Blockchain, co oznacza
kopanie bloków a także w jaki sposób zapewniane jest bezpieczeństwo oraz czym jest fork Blockchaina.  Kolejny rozdział
poświęcę na opisane co nowego umożliwia Ethereum w stosunku do Bitcoina.

% \hfill mds
% \hfill August 26, 2015

\section{Wartość waluty}
W tym rozdziale chciałbym się
